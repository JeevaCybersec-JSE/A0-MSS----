...
const SECTIONS = [
  ...
  { id: 'email',       name: 'Email Security',                 icon: 'mail' },
...
const METRICS = [
  ...
  { id: 'mobile_devices', section: 'endpoint', label: 'Mobile devices', direction: 'trend', mode: 'direct', unit: '', desc: 'Enrolled mobile devices at month end (MDM)' },
  ...
  // ---------------- Email Security ----------------
  { id: 'email_threats_quarantined', section: 'email', label: 'Email threats quarantined', direction: 'trend', mode: 'direct', unit: '', desc: 'Malicious or suspicious emails quarantined' },
  { id: 'phishing_blocked', section: 'email', label: 'Phishing emails blocked', direction: 'trend', mode: 'direct', unit: '', desc: 'Phishing messages blocked at the gateway' },
  { id: 'user_reported_phishing', section: 'email', label: 'User-reported phishing', direction: 'trend', mode: 'direct', unit: '', desc: 'Messages reported by users via the report button' },
  ...
  // ---------------- Service Delivery ----------------
  { id: 'support_requests', section: 'service', label: 'Support requests', direction: 'trend', mode: 'direct', unit: '', desc: 'Billable and contracted hours consumed' },
  ...
  // ---------------- Compliance ----------------
  { id: 'iso_evidence_completed', section: 'compliance', label: 'ISO evidence requests completed', direction: 'trend', mode: 'direct', unit: '', desc: 'Evidence requests fulfilled during the month' },
